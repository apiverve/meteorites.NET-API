...
namespace APIVerve
{
    public class MeteoriteLandingsAPIClient
    {
        ...
        public MeteoriteLandingsAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public MeteoriteLandingsAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
